...
RedeemingInfo=$BETTING_GAME/Data/RedeemingInfo.json
...
cardano-cli transaction build \
    ...
    \
    --tx-out $Betting_ADDRESS+$BET_PRICE+"1 $Game_NFT" \
    --tx-out-inline-datum-file $PoolInfo \
    \
    --tx-out $Redeeming_ADDRESS+$JACKPOT \
    --tx-out-inline-datum-file $RedeemingInfo \
    \
